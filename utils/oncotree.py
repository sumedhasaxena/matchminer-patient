...
def get_all_oncotree_data():
    ...
    for row in rows:
        ...
        level_2_list.add(level_2)
        level_3_list.add(level_3)
        mapping_l1_all[level_1].update({level_2, level_3}) 
    ...
    for s in mapping_l1_all.values():
        if '' in s:
            s.remove('')
    return level_1_list, level_2_list, level_3_list, mapping_l1_all, level1_to_level2, level2_to_level3
